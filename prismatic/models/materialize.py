...
VISION_BACKBONES = {
    ...
    "dinosiglip-vit-so-224px": {"cls": DinoSigLIPViTBackbone, "kwargs": {"default_image_size": 224, "vision_models_path":"/inspire/hdd/global_user/chengdongzhou-240108390137/ai_models/timm"}},
