...
###
 ...
 # @LastEditTime: 2025-10-11 20:49:47
 # @FilePath: \vla_adapter\run_scripts\train\vla_adapter\libero_pro\debug_libero_10_c2f.sh
### 
...
#========== Training Execution ==========#
python -m debugpy --listen 1234 --wait-for-client '/root/anaconda3/envs/vla-adapter/bin/torchrun' --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune_proprio.py \
  --vlm_path $vlm_path \
