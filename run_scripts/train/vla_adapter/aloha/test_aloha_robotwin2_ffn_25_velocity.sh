...
MODE=${RUN_MODE}_vel_loss_${velocity_loss_weight}_inner${expand_inner_ratio}_pt_${proj_type}_ft_${ffn_type}_mlp_${mlp_type}_fn_${decoder_num_blocks}
#========== !NOTE! ==========#
