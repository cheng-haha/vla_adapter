...
#========== !NOTE! ==========#
RUN_MODE=simvla_new_phone_stand_16
...
MODE=${RUN_MODE}_q${multi_queries_num}_r${num_residual_heads}_inner${expand_inner_ratio}_proj_type_${proj_type}_ffn_type_${ffn_type}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
