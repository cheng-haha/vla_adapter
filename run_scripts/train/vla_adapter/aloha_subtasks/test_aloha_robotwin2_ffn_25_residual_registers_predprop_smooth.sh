...
split_inputs=False
action_loss_type=smoothl1
MODE=${RUN_MODE}_smooth_q${multi_queries_num}_in${expand_inner_ratio}_proj_type_${proj_type}_ffn_type_${ffn_type}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
