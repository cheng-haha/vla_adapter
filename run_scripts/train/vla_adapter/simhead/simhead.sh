...
ffn_type=gelu
use_l2norm=True
expand_inner_ratio=3.0
MODE=${RUN_MODE}_newexinner_${expand_inner_ratio}_without_ap_ffn_type_${ffn_type}_use_l2norm${use_l2norm}_mlp_${mlp_type}_num_${decoder_num_blocks}
#========== !NOTE! ==========#
