...
#========== run ==========#
WANDB_CONSOLE=off WANDB_MODE=offline python -m debugpy --listen 1234 --wait-for-client '/opt/conda/envs/openvla-oft/bin/torchrun' --nnodes 1 --nproc-per-node 4 vla-scripts/finetune.py \
  --vla_path "$vla_path" \
