...
use_adaln_zero=True
MODE=${RUN_MODE}_newexinner_${expand_inner_ratio}_proj_type_${proj_type}_ffn_type_${ffn_type}_use_l2norm${use_l2norm}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
