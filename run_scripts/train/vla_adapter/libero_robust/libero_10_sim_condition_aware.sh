...
###
 ...
 # @LastEditTime: 2025-10-08 02:44:10
 # @FilePath: \vla_adapter\run_scripts\train\vla_adapter\libero_robust\libero_10_sim_condition_aware.sh
### 
...
perturbation_type="condition_aware"
# Wandb settings
...
run_id_note="sim-perturbation_std${perturbation_std}"
