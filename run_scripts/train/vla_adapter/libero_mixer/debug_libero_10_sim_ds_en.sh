...
###
 ...
 # @LastEditTime: 2025-10-10 00:51:14
 # @FilePath: \vla_adapter\run_scripts\train\vla_adapter\libero_ds\libero_10_sim_ds_debug.sh
### 
...
#========== Training Execution ==========#
python -m debugpy --listen 1234 --wait-for-client '/root/anaconda3/envs/vla-adapter/bin/torchrun' --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune_ds.py \
  --vlm_path $vlm_path \
  ...
  --deep_supervise_ensemble $deep_supervise_ensemble
