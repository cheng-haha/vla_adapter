...
###
 ...
 # @LastEditTime: 2025-10-10 17:11:53
 # @FilePath: \vla_adapter\run_scripts\train\vla_adapter\libero_mixer\debug_libero_10_sim_mixer_2.sh
### 
...
python -m debugpy --listen 1234 --wait-for-client '/root/anaconda3/envs/vla-adapter/bin/torchrun' --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune.py \
  ...
  --mlp_mixer_depth $mlp_mixer_depth \
