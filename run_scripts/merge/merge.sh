...
lora_finetuned_checkpoint_dir=/inspire/hdd/global_user/chengdongzhou-240108390137/vla_projects/VLA-Adapter/outputs/libero_10_no_noops/sim-weighted_img2_miniTrue_propTrue_proTrue_filmFalse-20251009_011639/configs+libero_10_no_noops+b16+lr-0.0002+MS-60005-DS-30000+lora-r64+dropout-0.0--image_aug--sim-weighted--60000_chkpt
