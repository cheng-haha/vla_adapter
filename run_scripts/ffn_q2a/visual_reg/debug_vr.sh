...
MODE=${RUN_MODE}_use_vr${use_visual_regression}_proj_type_${proj_type}_ffn_type_${ffn_type}_use_one_${use_one_embed}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
