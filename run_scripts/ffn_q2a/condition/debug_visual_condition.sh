...
ffn_type=gelu
use_adaln_zero=True
use_visualcondition=True
MODE=${RUN_MODE}use_visualcondition${use_visualcondition}_proj_type_${proj_type}_ffn_type_${ffn_type}_use_adaln_zero_${use_adaln_zero}_use_one_${use_one_embed}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
