...
#========== !NOTE! ==========#
RUN_MODE=simvla2_latentms_S4M8L16
use_predict_future_prop=False
batch_size=16
use_action_ts_head=True
use_one_embed=True
use_multi_scaling=True
use_latent_ms=True
mlp_type=ffn
decoder_num_blocks=6
robot_platform=multi_li
MODE=${RUN_MODE}_mq_${multi_queries_num}_use_pp_${use_predict_future_prop}_use_ts_${use_action_ts_head}_use_one_${use_one_embed}_use_ms_${use_multi_scaling}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
