...
model_name = 'vit_so400m_patch14_siglip_224'          # 同理可换 siglip 版本
checkpoint_path = '/inspire/hdd/global_user/chengdongzhou-240108390137/ai_models/timm/ViT-SO400M-14-SigLIP/open_clip_pytorch_model.bin'
target_res = 224
