...
multi_queries_num=2
multi_query_norm_type=per_limb_layernorm
action_norm=l2
MODE=${RUN_MODE}_l2_inner${expand_inner_ratio}_pt_${proj_type}_ft_${ffn_type}_mlp_${mlp_type}_fn_${decoder_num_blocks}
#========== !NOTE! ==========#
