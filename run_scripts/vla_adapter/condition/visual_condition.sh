...
MODE=${RUN_MODE}_uv${use_visualcondition}_proj_type_${proj_type}_ffn_type_${ffn_type}_use_adaln_zero_${use_adaln_zero}_mlp_${mlp_type}_decoder_num_blocks_${decoder_num_blocks}
#========== !NOTE! ==========#
